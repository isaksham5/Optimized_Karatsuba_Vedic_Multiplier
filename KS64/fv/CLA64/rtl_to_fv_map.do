...
# Generated on: Fri Apr 17 20:18:13 IST 2026 (Fri Apr 17 14:48:13 UTC 2026)
...
set logfile fv/CLA64/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/CLA64 -revised fv_map
...
add_search_path /home/userdata/25bvd0079/KS64 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS64/CLA64.v /home/userdata/25bvd0079/KS64/CLA16.v /home/userdata/25bvd0079/KS64/CLA4.v /home/userdata/25bvd0079/KS64/initialize.v
elaborate_design -golden -root {CLA64} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/CLA64/fv_map.v.gz
elaborate_design -revised -root {CLA64}
...
set_system_mode lec
write_compared_points noneq.compared_points.CLA64.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.CLA64.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.CLA64.rtl.fv_map.rpt
