...
# Generated on: Fri Apr 17 19:30:25 IST 2026 (Fri Apr 17 14:00:25 UTC 2026)
...
set logfile fv/RCA64/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/RCA64 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS64/RCA64.v /home/userdata/25bvd0079/KS64/full_adder.v
elaborate_design -golden -root {RCA64} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/RCA64/fv_map.v.gz
elaborate_design -revised -root {RCA64}
...
write_compared_points noneq.compared_points.RCA64.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.RCA64.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.RCA64.rtl.fv_map.rpt
