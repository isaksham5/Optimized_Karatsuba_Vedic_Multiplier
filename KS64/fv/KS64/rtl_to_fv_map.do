...
# Generated on: Fri Apr 17 19:29:08 IST 2026 (Fri Apr 17 13:59:08 UTC 2026)
...
set logfile fv/KS64/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/KS64 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS64/KS64.v /home/userdata/25bvd0079/KS64/grey_cell.v /home/userdata/25bvd0079/KS64/black_cell.v
elaborate_design -golden -root {KS64} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/KS64/fv_map.v.gz
elaborate_design -revised -root {KS64}
...
set_system_mode lec
write_compared_points noneq.compared_points.KS64.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.KS64.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.KS64.rtl.fv_map.rpt
