...
report_timing > ./reports/RCA32_timing.rpt
report_area > ./reports/RCA32_area.rpt
report_power > ./reports/RCA32_power.rpt
report_qor > ./reports/RCA32_qor.rpt

write_hdl >  ./netlist/RCA32_netlist.v
write_sdc >  ./netlist/RCA32_netlist.sdc
