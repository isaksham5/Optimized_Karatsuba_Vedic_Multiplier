...
# Generated on: Mon Apr 13 21:55:47 IST 2026 (Mon Apr 13 16:25:47 UTC 2026)
...
set logfile fv/KS32/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/KS32 -revised fv_map
...
add_search_path /home/userdata/25bvd0079/KS16 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  KS32.v /home/userdata/25bvd0079/KS16/grey_cell.v /home/userdata/25bvd0079/KS16/black_cell.v
elaborate_design -golden -root {KS32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/KS32/fv_map.v.gz
elaborate_design -revised -root {KS32}
...
set_system_mode lec
write_compared_points noneq.compared_points.KS32.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.KS32.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.KS32.rtl.fv_map.rpt
