...
# Generated on: Mon Apr 13 21:57:33 IST 2026 (Mon Apr 13 16:27:33 UTC 2026)
...
set logfile fv/RCA32/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/RCA32 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  RCA32.v
elaborate_design -golden -root {RCA32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/RCA32/fv_map.v.gz
elaborate_design -revised -root {RCA32}
...
write_compared_points noneq.compared_points.RCA32.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.RCA32.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.RCA32.rtl.fv_map.rpt
