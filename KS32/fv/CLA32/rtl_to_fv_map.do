...
# Generated on: Mon Apr 13 22:30:45 IST 2026 (Mon Apr 13 17:00:45 UTC 2026)
...
set logfile fv/CLA32/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/CLA32 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  CLA32.v
elaborate_design -golden -root {CLA32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/CLA32/fv_map.v.gz
elaborate_design -revised -root {CLA32}
...
set_system_mode lec
write_compared_points noneq.compared_points.CLA32.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.CLA32.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.CLA32.rtl.fv_map.rpt
