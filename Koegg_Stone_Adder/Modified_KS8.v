...
grey_cell b9(G[1],P[1],G1[0],G2[0]);
...
grey_cell b16(G1[3],P1[3],G2[0],G3[0]);
grey_cell b17(G1[4],P1[4],G2[1],G3[1]);
grey_cell b18(G2[4],P2[4],G2[0],G3[2]);
grey_cell b19(G2[5],P2[5],G2[1],G3[3]);
grey_cell b20(G2[6],P2[6],G1[3],G3[4]);
