...
# Generated on: Fri Apr 17 21:41:03 IST 2026 (Fri Apr 17 16:11:03 UTC 2026)
...
set logfile fv/CLA128/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/CLA128 -revised fv_map
...
add_search_path /home/userdata/25bvd0079/KS128 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS128/CLA128.v /home/userdata/25bvd0079/KS128/CLA16.v /home/userdata/25bvd0079/KS128/CLA4.v /home/userdata/25bvd0079/KS128/initialize.v
elaborate_design -golden -root {CLA128} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/CLA128/fv_map.v.gz
elaborate_design -revised -root {CLA128}
...
set_system_mode lec
write_compared_points noneq.compared_points.CLA128.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.CLA128.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.CLA128.rtl.fv_map.rpt
