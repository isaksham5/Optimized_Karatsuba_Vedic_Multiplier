...
# Generated on: Fri Apr 17 21:17:04 IST 2026 (Fri Apr 17 15:47:04 UTC 2026)
...
set logfile fv/KS128/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/KS128 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS128/KS128.v /home/userdata/25bvd0079/KS128/grey_cell.v /home/userdata/25bvd0079/KS128/black_cell.v
elaborate_design -golden -root {KS128} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/KS128/fv_map.v.gz
elaborate_design -revised -root {KS128}
...
add_black_box initialize -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.KS128.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.KS128.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.KS128.rtl.fv_map.rpt
