...
# Generated on: Fri Apr 17 21:56:28 IST 2026 (Fri Apr 17 16:26:28 UTC 2026)
...
set logfile fv/RCA128/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/RCA128 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/25bvd0079/KS128/RCA128.v /home/userdata/25bvd0079/KS128/full_adder.v
elaborate_design -golden -root {RCA128} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/RCA128/fv_map.v.gz
elaborate_design -revised -root {RCA128}
...
set_system_mode lec
write_compared_points noneq.compared_points.RCA128.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.RCA128.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.RCA128.rtl.fv_map.rpt
